...
int main() {
	...
	*/
	...
	GLuint colorTextureBuffer;
	glGenBuffers(1, &colorTextureBuffer);
	glBindBuffer(GL_TEXTURE_BUFFER, colorTextureBuffer);
	glBufferData(GL_TEXTURE_BUFFER, sizeof colors, colors, GL_STATIC_DRAW);

	GLuint colorTex;
	glGenTextures(1, &colorTex);
	glBindTexture(GL_TEXTURE_BUFFER, colorTex);
	glTexBuffer(GL_TEXTURE_BUFFER, GL_RGBA32F, colorTextureBuffer);
